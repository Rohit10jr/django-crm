...
# [!!] use DRF inbuilt pagination classes
class InvoiceListView(APIView, LimitOffsetPagination):
    ...
    def get_context_data(self, **kwargs):
        ...
        if params:
            # [??] if we get multiple params, does it filter any?
    ...
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            ...
            # [!!] instead of overriding fields here use source in serializers or get fields together and then save it
...
class InvoiceDetailView(APIView):
    ...
    def delete(self, request, pk, format=None):
        ...
        # [!!] CASCADE can do this, so why this? 
...
class InvoiceCommentView(APIView):
    ...
    def put(self, request, pk, format=None):
        ...
        # [!!] this is repeated in multiple views
        if (
            request.user.role == "ADMIN"
