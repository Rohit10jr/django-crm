...
class OpportunityCreateSerializer(serializers.ModelSerializer):
    ...
    def __init__(self, *args, **kwargs):
        request_obj = kwargs.pop("request_obj", None) # [!!] request_obj is the request object and update it to context
    ...
    def validate_name(self, name):
        if self.instance: # editing existing opportunity
            if (
